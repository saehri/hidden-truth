...
export default function BackButton({
  ...
  return (
    ...
    >
      <span className='bg-yellow-800/50 block border border-border border-t-0 border-l-0 p-1 xl:p-2 pr-3 sm:pr-4 xl:pr-8 md:pl-2 rounded-br-2xl'>
        <Icons.Back className='w-4 h-4 lg:w-5 lg:h-5 3xl:w-8 3xl:h-8' />
      </span>

      <span className='text-border text-xs lg:text-sm 3xl:text-base uppercase font-[500] text-yellow-500'>
        {buttonName}
      </span>
    </Button>
  );
